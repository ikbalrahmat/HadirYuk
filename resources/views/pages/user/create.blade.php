    ...
    <div class="bg-white p-4 rounded-4 shadow-sm">
        ...
        <form action="{{ route('user.store') }}" method="POST" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="unit_kerja" id="unit_kerja" class="form-control" placeholder="Masukkan unit kerja (contoh: P3T, PPA)" required>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function togglePermissions() {
            ...
            if (roleValue === 'user' || roleValue === 'yanum') {
        ...
        roleSelect.addEventListener('change', togglePermissions);
        togglePermissions(); // Panggil saat pertama load
    });
</script>
@endpush --}}
...
<div class="p-6">
    <div class="bg-white p-6 rounded-2xl shadow">
        ...
        <form action="{{ route('user.store') }}" method="POST" autocomplete="off" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" id="name" placeholder="Masukkan nama lengkap" required class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
            </div>

            <div>
                <label for="email" class="block text-sm font-semibold mb-1">Email</label>
                <input type="email" name="email" id="email" placeholder="Masukkan email" autocomplete="off" required class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
            </div>

            <div>
                <label for="password" class="block text-sm font-semibold mb-1">Password</label>
                <input type="password" name="password" id="password" placeholder="Password" autocomplete="new-password" required class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
            </div>

            <div>
                <label for="unit_kerja" class="block text-sm font-semibold mb-1">Unit Kerja</label>
                <input type="text" name="unit_kerja" id="unit_kerja" placeholder="Masukkan unit kerja (contoh: P3T, PPA)" required class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
            ...
            <div id="permissionGroup" class="hidden">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="permissions[]" value="{{ $perm->name }}" id="perm_{{ $perm->id }}" class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
